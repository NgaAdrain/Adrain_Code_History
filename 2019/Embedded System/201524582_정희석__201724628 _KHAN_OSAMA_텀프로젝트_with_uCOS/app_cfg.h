...
*********************************************************************************************************
*                                            TASK PRIORITIES
*                                 TASK START(Input Task) -> priority : 3 (high)
*                                 TASK PROCESSING(Process Task) -> priority : 4 (middle)
*                                 TASK OUTPUT(Output Task) -> priority : 5 (low)
*********************************************************************************************************
*/

#define  APP_TASK_START_PRIO                               3
#define  APP_PRO_TASK_START_PRIO                           4
#define  APP_OUT_TASK_START_PRIO                           5
...
*                              - Process Task, Output Task's STACK SIZE Add
*********************************************************************************************************
*/

#define  APP_TASK_START_STK_SIZE                         128
#define  APP_PRO_TASK_START_STK_SIZE                     128
#define  APP_OUT_TASK_START_STK_SIZE                     128
